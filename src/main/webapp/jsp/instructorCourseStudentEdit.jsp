	...
	<div class="container theme-showcase" id="frameBodyWrapper">
		...
		<div class="panel panel-primary">
			<div class="panel-body fill-plain">
				<form
					action="<%=Const.ActionURIs.INSTRUCTOR_COURSE_STUDENT_DETAILS_EDIT_SAVE%>"
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input class="form-control"
								name="<%=Const.ParamsNames.STUDENT_NAME%>"
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input class="form-control"
								name="<%=Const.ParamsNames.SECTION_NAME%>"
					...
					<div class="form-group">
						<label class="col-sm-1 control-label">E-mail Address: <input
							type="hidden" name="<%=Const.ParamsNames.STUDENT_EMAIL%>"
							id="<%=Const.ParamsNames.STUDENT_EMAIL%>"
							value="<%=sanitizeForHtml(data.student.email)%>">
						</label>
						<div class="col-sm-11">
							<input class="form-control"
								name="<%=Const.ParamsNames.NEW_STUDENT_EMAIL%>"
					...
					<div class="align-center">
						<input type="submit" class="btn btn-primary" id="button_submit"
