		...
		<div id="frameBodyWrapper" class="container">
						...
						<form method="get" action="<%=data.getInstructorSearchLink()%>"
							...
							<div class="input-group">
								<input type="text" name="<%=Const.ParamsNames.SEARCH_KEY%>"
									title="Search for comment" class="form-control"
									placeholder="Any info related to comments" id="searchBox">
			...
			<div class="well well-plain">
				<div class="row">
					<div class="col-md-2">
						<div class="checkbox">
							<input id="option-check" type="checkbox"> <label
								for="option-check">Show More Options</label>
						</div>
					</div>
					<div class="col-md-3">
						<div class="checkbox">
							...
							<div id="displayArchivedCourses_link" style="display: none;">
								<a href="<%=data.getInstructorCommentsLink()%>">link back to
									the page</a>
							</div>
						</div>
					</div>
						...
						<form class="form-horizontal" role="form">
							<div class="row">
								<div class="col-sm-4">
									...
									<br>
									<div class="checkbox">
										<input id="panel_all" type="checkbox" checked="checked">
                                    ...
                                    %>
									<div class="checkbox">
										<input id="panel_check-<%=panelIdx%>" type="checkbox"
											checked="checked"> <label
											for="panel_check-<%=panelIdx%>"> Students </label>
									</div>
									<% } %>
									...
									<div class="checkbox">
										<input id="panel_check-<%=panelIdx%>" type="checkbox"
											checked="checked"> <label
											for="panel_check-<%=panelIdx%>"> Session: <%=fs.feedbackSessionName%>
										</label>
									</div>
									<% } %>
								</div>
								<div class="col-sm-4">
									...
									<br>
									<div class="checkbox">
										<input type="checkbox" value="" id="giver_all"
											checked="checked"> <label for="giver_all"><strong>All</strong></label>
									</div>
									<br>
									<div class="checkbox">
										<input id="giver_check-by-you" type="checkbox"
											checked="checked"> <label for="giver_check-by-you">
											You </label>
									</div>
									<div class="checkbox">
										<input id="giver_check-by-others" type="checkbox"
											checked="checked"> <label for="giver_check-by-others">
											Others </label>
									</div>
								</div>
								<div class="col-sm-4">
									...
									<br>
									<div class="checkbox">
										<input type="checkbox" value="" id="status_all"
											checked="checked"> <label for="status_all"><strong>All</strong></label>
									</div>
									<br>
									<div class="checkbox">
										<input id="status_check-public" type="checkbox"
											checked="checked"> <label for="status_check-public">
											Public </label>
									</div>
									<div class="checkbox">
										<input id="status_check-private" type="checkbox"
											checked="checked"> <label for="status_check-private">
											Private </label>
									</div>
								</div>
							</div>
			...
			<div class="well well-plain">
				<div class="row">
					...
					<div class="btn-group pull-right"
						style="<%=data.numberOfPendingComments==0?"display:none":""%>">
						<a type="button" class="btn btn-sm btn-info" data-toggle="tooltip"
				...
				<div id="no-comment-panel"
					style="<%=data.comments.keySet().size() == 0 && data.feedbackSessions.size() == 0?"":"display:none;"%>">
					<br>
					<div class="panel">
						<div class="panel-body">You don't have any comment in this
							course.</div>
					</div>
				</div>
				<%  panelIdx = 0;
					...
					<div class="panel panel-primary">
                        ...
                        %>
							<div
								...
								<% if (data.comments.get(giverEmail).isEmpty()) { %>
								style="display: none;" <% } %>>
								<div class="panel-heading">
									...
									<li id="<%=comment.getCommentId()%>"
										...
										<form method="post"
											...
											<div id="commentBar-<%=commentIdx%>">
												...
												<span class="text-muted">To <%=data.getRecipientNames(comment.recipients)%>
													on <%=TimeHelper.formatTime(comment.createdAt)%></span>
												<%
                                        ...
                                        %>
														...
														<tbody>
															...
															<tr id="recipient-course<%=commentIdx%>">
																...
																<td><input
																	class="visibilityCheckbox answerCheckbox"
																	type="checkbox"
																	value="<%=CommentRecipientType.COURSE%>"
											...
											<input type="hidden"
												...
												name=<%=Const.ParamsNames.FROM_COMMENTS_PAGE%> value="true">
											<input type="hidden"
				...
				<div id="panel_display-<%=panelIdx%>">
					...
					<div class="panel panel-primary">
						<div class="panel-heading"
							onclick="loadFeedbackResponseComments('<%=data.account.googleId%>','<%=data.courseId%>','<%=fsName%>', this);"
								...
								<div class="panel panel-info">
									<ul class="list-group comments">
										<li class="list-group-item list-group-item-danger">
											Failed to load response comments for this session. Please try
											again later.</li>
									</ul>
								</div>
							</div>
			...
			<% } else { %>
			<div id="statusMessage" class="alert alert-warning">There is no
				comment to display</div>
