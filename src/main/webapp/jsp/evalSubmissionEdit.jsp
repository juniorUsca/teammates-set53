...
<input type="hidden"
	value="<%=EvalSubmissionEditPageData.sanitizeForHtml(data.eval.name)%>"
	name="<%=Const.ParamsNames.EVALUATION_NAME%>"
	id="<%=Const.ParamsNames.EVALUATION_NAME%>">
<input type="hidden"
	value="<%=EvalSubmissionEditPageData.sanitizeForHtml(data.student.team)%>"
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<div class="form-group">
			<label class="col-sm-2 control-label">My estimated
				contribution:</label>
			<div class="col-sm-10">
				<select class="form-control" name="<%=Const.ParamsNames.POINTS%>"
					id="<%=Const.ParamsNames.POINTS+idx%>" <%=data.disableAttribute%>>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea class="form-control" rows="8"
					...
					id="<%=Const.ParamsNames.COMMENTS+idx%>" <%=data.disableAttribute%>><%=data.getP2PComments(sub)%></textarea>
			</div>
			<%
                        } else {
                    %>
			<div class="col-sm-10">
				<font color="red"> <textarea class="form-control" rows="1"
						name="<%=Const.ParamsNames.COMMENTS%>"
						id="<%=Const.ParamsNames.COMMENTS+idx%>" disabled="disabled">N.A.</textarea>
				</font>
			</div>
			<%
                        }
	...
	<div class="panel-body">
		<div class="form-group">
			<label class="col-sm-2 control-label">His/Her estimated
				contribution:</label>
			<div class="col-sm-10">
				<select class="form-control" name="<%=Const.ParamsNames.POINTS%>"
					id="<%=Const.ParamsNames.POINTS+idx%>" <%=data.disableAttribute%>>
