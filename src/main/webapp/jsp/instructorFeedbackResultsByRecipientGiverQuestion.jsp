...
<script type="text/javascript"
	src="/js/instructorFeedbackResultsAjaxByRGQ.js"></script>
<script type="text/javascript"
							...
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<div class="middlealign profile-pic-icon-hover inline"
										...
										<strong><%=responsesForRecipient.getKey()%></strong> <img
											src="" alt="No Image Given"
											class="hidden profile-pic-icon-hidden"> <a
											class="link-in-dark-bg" href="mailTo:<%= targetEmail%> "
											<%=mailtoStyleAttr%>>[<%=targetEmail%>]
										</a>
									</div>
									<% } else {%>
											...
											<div class="col-md-2">
												<div class="col-md-12">
													...
													<div
														...
														data-link="<%=data.getProfilePictureLink(giverEmail)%>">
