...
<%@ page
	import="teammates.ui.controller.InstructorEvalSubmissionEditPageData"%>
<%
	...
	<div class="container theme-showcase" id="frameBodyWrapper">
		...
		<div class="well well-plain">
			<div class="form form-horizontal" id="studentEvaluationInfo">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label text-bold">Evaluation
						Name:</label>
					<div class="col-sm-9">
		...
		<div id="studentEvaluationSubmissions">
			<form name="form_submitevaluation" class="form form-horizontal"
				id="form_submitevaluation" method="post"
				...
				<div class="align-center">
					<input type="submit" class="btn btn-primary align-center"
						...
						onclick="return checkEvaluationForm(this.form)" id="button_submit"
						value="Save Changes">
				</div>
