...
<body
	...
	<div id="frameBodyWrapper" class="container">
		...
		<div class="well well-plain">
			<form class="form-group" method="post"
				...
				<div class="row">
					<div class="col-sm-12">
						<span class="pull-right"> <a class="btn btn-primary btn-sm"
							id="fsEditLink" title="<%=Const.Tooltips.FEEDBACK_SESSION_EDIT%>"
							data-toggle="tooltip" data-placement="top"
							onclick="enableEditFS()"> Edit </a>
							<button type="submit" id="fsSaveLink" style="display: none;"
								class="btn btn-primary btn-sm"
								onclick="return checkEditFeedbackSession(this.form);">
								Save Changes</button> <a
							href="<%=data.getInstructorFeedbackSessionDeleteLink(data.session.courseId, data.session.feedbackSessionName, "")%>"
							...
							data-toggle="tooltip" data-placement="top"
							class="btn btn-primary btn-sm" id="fsDeleteLink"> Delete </a>
						</span>
					</div>
				</div>
				<br>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-sm-4 control-label"
										...
										data-toggle="tooltip" data-placement="top">Course</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<h5 class="col-sm-4">
										<label for="<%=Const.ParamsNames.FEEDBACK_SESSION_TIMEZONE%>"
											...
											data-toggle="tooltip" data-placement="top">Timezone</label>
									</h5>
									<div class="col-sm-8">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="<%=Const.ParamsNames.FEEDBACK_SESSION_NAME%>"
										...
										data-toggle="tooltip" data-placement="top">Session
										name</label>
									<div class="col-sm-10">
										<div class="form-control-static">
								...
								<div class="form-group">
									<div class="form-group">
										<label
											...
											data-toggle="tooltip" data-placement="top">Instructions</label>
										<div class="col-sm-10">
								...
								<div class="row">
									<div class="col-md-6">
										<label for="<%=Const.ParamsNames.FEEDBACK_SESSION_STARTDATE%>"
											class="label-control">Submission opening time</label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-6">
										<label for="<%=Const.ParamsNames.FEEDBACK_SESSION_ENDDATE%>"
											class="label-control">Submission closing time</label>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-12">
										<label
											...
											class="control-label">Grace period</label>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-12">
				...
				<div class="row" id="uncommonSettingsInfo">
					<div class="col-md-12 text-muted">
						<span id="uncommonSettingsInfoText"> </span> <a
							id="editUncommonSettingsButton" data-edit="[Edit]"
							data-done="[Done]" onclick="enableEditFS()">[Edit]</a>
					</div>
				</div>
							...
							<div class="col-md-6">
								...
								<div class="row radio">
									<div class="col-md-6"
										...
										<label
											...
											opening time </label> <input type="radio"
											name="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>"
								...
								<div class="row radio">
									<div class="col-md-6"
										...
										data-toggle="tooltip" data-placement="top">
										<label
											for="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>_never">
											Never (this is a private session) </label> <input type="radio"
											name="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>"
							...
							<div class="col-md-6 border-left-gray">
								...
								<div class="row radio">
									<div class="col-md-3"
										...
										data-toggle="tooltip" data-placement="top">
										<label
											for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_atvisible">
											Immediately </label> <input type="radio"
											name="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>"
								...
								<div class="row radio">
									<div class="col-md-4"
										...
										data-toggle="tooltip" data-placement="top">
										<label
											for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_later">
											Publish manually </label> <input type="radio"
								...
								<div class="row radio">
									<div class="col-md-2"
										...
										data-toggle="tooltip" data-placement="top">
										<label
											for="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>_never">
											Never </label> <input type="radio"
											name="<%=Const.ParamsNames.FEEDBACK_SESSION_RESULTSVISIBLEBUTTON%>"
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-sm-3"
								...
								data-toggle="tooltip" data-placement="top">
								<div class="checkbox">
									<label> Session opening reminder </label> <input
										type="checkbox"
							...
							<div class="col-sm-3"
								...
								<div class="checkbox">
									<label
										for="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>_closing">
										Session closing reminder </label> <input type="checkbox"
							...
							<div class="col-sm-4"
								...
								<div class="checkbox">
									<label
										for="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>_published">
										Results published announcement </label> <input type="checkbox"
				...
				<div class="col-sm-12">
					<button type="submit" id="button_submit_edit"
						style="display: none;" class="btn btn-primary center-block"
						onclick="return checkEditFeedbackSession(this.form);">
						Save Changes</button>
				</div>
				<input type="hidden"
					name="<%=Const.ParamsNames.FEEDBACK_SESSION_NAME%>"
					value="<%=data.session.feedbackSessionName%>"> <input
					type="hidden" name="<%=Const.ParamsNames.COURSE_ID%>"
					value="<%=data.session.courseId%>"> <input type="hidden"
		...
		<%
            ...
            %>
		<div class="align-center bold" id="empty_message"><%=Const.StatusMessages.FEEDBACK_QUESTION_EMPTY%></div>
		<br> <br>
		<%
                }
            %>
		...
		<form class="form-horizontal form_question" role="form" method="post"
			...
			id="form_editquestion-<%=question.questionNumber%>"
			name="form_editquestions"
			...
			<div class="panel panel-primary questionTable"
				id="questionTable<%=question.questionNumber%>">
				<div class="panel-heading">
					<div class="row">
						<div class="col-sm-12">
							<span> <strong>Question</strong> <select
								class="questionNumber nonDestructive text-primary"
								name="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBER%>"
								id="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBER%>-<%=question.questionNumber%>">
									<%
                                for(int opt = 1; opt < data.questions.size()+1; opt++){
                                    out.println("<option value=" + opt +">" + opt + "</option>");
                                }
                            %>
							</select> &nbsp; <%=questionDetails.getQuestionTypeDisplayName()%>
							</span> <span class="pull-right"> <a
								class="btn btn-primary btn-xs"
								id="<%=Const.ParamsNames.FEEDBACK_QUESTION_GETLINK%>-<%=question.questionNumber%>"
								data-toggle="tooltip" data-placement="top"
								title="<%=Const.Tooltips.FEEDBACK_QUESTION_GETLINK%>"
								onclick="getQuestionLink(<%=question.questionNumber%>)">Get
									Link</a> <a class="btn btn-primary btn-xs"
								id="<%=Const.ParamsNames.FEEDBACK_QUESTION_EDITTEXT%>-<%=question.questionNumber%>"
								data-toggle="tooltip" data-placement="top"
								...
								id="<%=Const.ParamsNames.FEEDBACK_QUESTION_SAVECHANGESTEXT%>-<%=question.questionNumber%>">Save
									Changes</a> <a class="btn btn-primary btn-xs"
								onclick="deleteQuestion(<%=question.questionNumber%>)"
								data-toggle="tooltip" data-placement="top"
								title="<%=Const.Tooltips.FEEDBACK_QUESTION_DELETE%>">Delete</a>
							</span>
						</div>
					</div>
				</div>
				<div class="panel-body">
					<div>
						<textarea rows="5" class="form-control textvalue nonDestructive"
							...
							tabindex="9" disabled="disabled"><%=InstructorFeedbackEditPageData.sanitizeForHtml(questionDetails.questionText)%></textarea>
					</div>
					...
					<div>
						<div class="col-sm-6" data-toggle="tooltip" data-placement="top"
							...
							<label class="col-sm-4 control-label"> Feedback Giver: </label>
							<div class="col-sm-8">
								<select class="form-control participantSelect"
									name="<%=Const.ParamsNames.FEEDBACK_QUESTION_GIVERTYPE%>"
									id="<%=Const.ParamsNames.FEEDBACK_QUESTION_GIVERTYPE%>-<%=question.questionNumber%>"
									disabled="disabled"
						...
						<div class="col-sm-6" data-toggle="tooltip" data-placement="top"
							...
							<label class="col-sm-4 control-label"> Feedback
								Recipient: </label>
							<div class="col-sm-8">
								<select class="form-control participantSelect"
									name="<%=Const.ParamsNames.FEEDBACK_QUESTION_RECIPIENTTYPE%>"
									id="<%=Const.ParamsNames.FEEDBACK_QUESTION_RECIPIENTTYPE%>-<%=question.questionNumber%>"
									disabled="disabled"
					...
					<div class="row">
						...
						<div class="col-sm-6 btn-group" data-toggle="buttons">
							<label class="btn btn-xs btn-info visibilityOptionsLabel"
								id="visibilityOptionsLabel-<%=question.questionNumber%>"
								onchange="toggleVisibilityOptions(this)"> <input
								type="radio"> <span class="glyphicon glyphicon-pencil"></span>
								Edit Visibility </input>
							</label> <label
								class="btn btn-xs btn-info active visibilityMessageButton"
								id="visibilityMessageButton-<%=question.questionNumber%>"
								onchange="toggleVisibilityMessage(this)"> <input
								type="radio"> <span class="glyphicon glyphicon-eye-open"></span>
								Preview Visibility </input>
							</label>
						</div>
						<div
							class="col-sm-6 numberOfEntitiesElements<%=question.questionNumber%>">
							<label
								id="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES%>_text-<%=question.questionNumber%>"
								class="control-label col-sm-4 small"> The maximum number
								of <span
								id="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES%>_text_inner-<%=question.questionNumber%>"></span>
							...
							<div class="col-sm-8 form-control-static">
								<div class="col-sm-6">
									<input class="nonDestructive" type="radio"
										...
										<%=question.numberOfEntitiesToGiveFeedbackTo == Const.MAX_POSSIBLE_RECIPIENTS ? "" : "checked=\"checked\""%>
										value="custom" disabled="disabled"> <input
										class="nonDestructive numberOfEntitiesBox" type="number"
										name="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES%>"
										id="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES%>-<%=question.questionNumber%>"
										min="1" max="250"
										value=<%=question.numberOfEntitiesToGiveFeedbackTo == Const.MAX_POSSIBLE_RECIPIENTS ? 1 : question.numberOfEntitiesToGiveFeedbackTo%>
										disabled="disabled">
								</div>
								<div class="col-sm-6">
									<input class="nonDestructive" type="radio"
										name="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIESTYPE%>"
										<%=question.numberOfEntitiesToGiveFeedbackTo == Const.MAX_POSSIBLE_RECIPIENTS ? "checked=\"checked\"" : ""%>
										value="max" disabled="disabled"> <span class="">Unlimited</span>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12 text-muted visibilityMessage"
							id="visibilityMessage-<%=question.questionNumber%>">
					...
					<div class="visibilityOptions"
						id="visibilityOptions-<%=question.questionNumber%>">
						<br>
						<table
							class="dataTable participantTable table table-striped text-center">
							<tr>
							...
							<tr>
								...
								<td><input
									class="visibilityCheckbox answerCheckbox<%=question.questionNumber%> centered"
									...
									checked="checked" <%}%> /></td>
								<td><input
									class="visibilityCheckbox giverCheckbox<%=question.questionNumber%>"
									type="checkbox" value="<%=FeedbackParticipantType.RECEIVER%>"
									disabled="disabled"
									<%if(question.showGiverNameTo.contains(FeedbackParticipantType.RECEIVER)) {%>
									checked="checked" <%}%> /></td>
								<td><input
									class="visibilityCheckbox recipientCheckbox<%=question.questionNumber%>"
									name="receiverFollowerCheckbox" type="checkbox"
									value="<%=FeedbackParticipantType.RECEIVER%>"
									disabled="disabled"
									<%if(question.showRecipientNameTo.contains(FeedbackParticipantType.RECEIVER)) {%>
									checked="checked" <%}%> /></td>
							</tr>
							<tr>
								<td class="text-left">
									<div data-toggle="tooltip" data-placement="top"
										...
										Giver's Team Members</div>
								</td>
								<td><input
									class="visibilityCheckbox answerCheckbox<%=question.questionNumber%>"
									type="checkbox"
									value="<%=FeedbackParticipantType.OWN_TEAM_MEMBERS%>"
									disabled="disabled"
									<%if(question.showResponsesTo.contains(FeedbackParticipantType.OWN_TEAM_MEMBERS)) {%>
									checked="checked" <%}%> /></td>
								<td><input
									class="visibilityCheckbox giverCheckbox<%=question.questionNumber%>"
									type="checkbox"
									value="<%=FeedbackParticipantType.OWN_TEAM_MEMBERS%>"
									disabled="disabled"
									<%if(question.showGiverNameTo.contains(FeedbackParticipantType.OWN_TEAM_MEMBERS)) {%>
									checked="checked" <%}%> /></td>
								<td><input
									class="visibilityCheckbox recipientCheckbox<%=question.questionNumber%>"
									type="checkbox"
									value="<%=FeedbackParticipantType.OWN_TEAM_MEMBERS%>"
									disabled="disabled"
									<%if(question.showRecipientNameTo.contains(FeedbackParticipantType.OWN_TEAM_MEMBERS)) {%>
									checked="checked" <%}%> /></td>
							</tr>
							<tr>
								<td class="text-left">
								...
								<td><input
									...
									disabled="disabled"
									<%if(question.showResponsesTo.contains(FeedbackParticipantType.RECEIVER_TEAM_MEMBERS)) {%>
									checked="checked" <%}%> /></td>
								<td><input
									class="visibilityCheckbox giverCheckbox<%=question.questionNumber%>"
									type="checkbox"
									value="<%=FeedbackParticipantType.RECEIVER_TEAM_MEMBERS%>"
									disabled="disabled"
									<%if(question.showGiverNameTo.contains(FeedbackParticipantType.RECEIVER_TEAM_MEMBERS)) {%>
									checked="checked" <%}%> /></td>
								<td><input
									class="visibilityCheckbox recipientCheckbox<%=question.questionNumber%>"
									type="checkbox"
									value="<%=FeedbackParticipantType.RECEIVER_TEAM_MEMBERS%>"
									disabled="disabled"
									<%if(question.showRecipientNameTo.contains(FeedbackParticipantType.RECEIVER_TEAM_MEMBERS)) {%>
									checked="checked" <%}%> /></td>
							</tr>
							<tr>
								<td class="text-left">
								...
								<td><input
									...
									disabled="disabled"
									<%if(question.showResponsesTo.contains(FeedbackParticipantType.STUDENTS)) {%>
									checked="checked" <%}%> /></td>
								<td><input
									class="visibilityCheckbox giverCheckbox<%=question.questionNumber%>"
									type="checkbox" value="<%=FeedbackParticipantType.STUDENTS%>"
									disabled="disabled"
									<%if(question.showGiverNameTo.contains(FeedbackParticipantType.STUDENTS)) {%>
									checked="checked" <%}%> /></td>
								<td><input
									class="visibilityCheckbox recipientCheckbox<%=question.questionNumber%>"
									type="checkbox" value="<%=FeedbackParticipantType.STUDENTS%>"
									disabled="disabled"
									<%if(question.showRecipientNameTo.contains(FeedbackParticipantType.STUDENTS)) {%>
									checked="checked" <%}%> /></td>
							</tr>
							<tr>
								<td class="text-left">
								...
								<td><input
									...
									disabled="disabled"
									<%if(question.showResponsesTo.contains(FeedbackParticipantType.INSTRUCTORS)) {%>
									checked="checked" <%}%> /></td>
								<td><input
									class="visibilityCheckbox giverCheckbox<%=question.questionNumber%>"
									type="checkbox"
									value="<%=FeedbackParticipantType.INSTRUCTORS%>"
									disabled="disabled"
									<%if(question.showGiverNameTo.contains(FeedbackParticipantType.INSTRUCTORS)) {%>
									checked="checked" <%}%> /></td>
								<td><input
									class="visibilityCheckbox recipientCheckbox<%=question.questionNumber%>"
									type="checkbox"
									value="<%=FeedbackParticipantType.INSTRUCTORS%>"
									disabled="disabled"
									<%if(question.showRecipientNameTo.contains(FeedbackParticipantType.INSTRUCTORS)) {%>
									checked="checked" <%}%> /></td>
							</tr>
						</table>
					</div>
					<div>
						<span class="pull-right"> <input
							id="button_question_submit-<%=question.questionNumber%>"
			...
			<input type="hidden"
				...
				name="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBER%>"
				value="<%=question.questionNumber%>"> <input type="hidden"
				name="<%=Const.ParamsNames.FEEDBACK_QUESTION_TYPE%>"
				value=<%=question.questionType.toString()%>> <input
				type="hidden"
				name="<%=Const.ParamsNames.FEEDBACK_QUESTION_EDITTYPE%>"
				id="<%=Const.ParamsNames.FEEDBACK_QUESTION_EDITTYPE%>-<%=question.questionNumber%>"
				value="edit"> <input type="hidden"
				name="<%=Const.ParamsNames.FEEDBACK_QUESTION_SHOWRESPONSESTO%>">
			<input type="hidden"
				name="<%=Const.ParamsNames.FEEDBACK_QUESTION_SHOWGIVERTO%>">
			<input type="hidden"
				name="<%=Const.ParamsNames.FEEDBACK_QUESTION_SHOWRECIPIENTTO%>">
		...
		<form method="post"
			...
			name="form_addquestions" class="form-horizontal form_question"
			role="form" onsubmit="tallyCheckboxes('')">
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="col-sm-8">
							<select class="form-control questionType"
								...
								<option value="CONSTSUM" disabled="disabled"
						...
						<div class="col-sm-1">
							<h5>
								<a href="/instructorHelp.html#fbQuestionTypes" target="_blank"><span
					...
					<div class="col-sm-2">
						<a id="button_openframe" class="btn btn-primary"
							...
							onclick="showNewQuestionFrame(document.getElementById('questionTypeChoice').value)">&nbsp;&nbsp;&nbsp;Add
							New Question&nbsp;&nbsp;&nbsp;</a>

					</div>
					<div class="col-sm-2">
						<a id="button_copy" class="btn btn-primary" value="Copy Question">&nbsp;&nbsp;&nbsp;Copy
							Question&nbsp;&nbsp;&nbsp;</a>
					</div>
					<div class="col-sm-2">
						<a class="btn btn-primary"
							href="<%= Const.ActionURIs.INSTRUCTOR_FEEDBACKS_PAGE + "?" + Const.ParamsNames.USER_ID + "=" + data.account.googleId + "&" + Const.ParamsNames.COURSE_ID + "=" + data.session.courseId%>"
							class="button">&nbsp;&nbsp;&nbsp;Done
							Editing&nbsp;&nbsp;&nbsp;</a>
					</div>
				</div>
			...
			<div class="panel panel-primary questionTable" id="questionTableNew"
				style="display: none;">
				<div class="panel-heading">
					<strong>Question</strong> <select
						class="questionNumber nonDestructive text-primary"
						name="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBER%>"
                    ...
                    %>
					</select> &nbsp; <span id="questionTypeHeader"></span> <span
						class="pull-right"> <a class="btn btn-primary btn-xs"
						onclick="deleteQuestion(-1)" data-toggle="tooltip"
						data-placement="top"
						title="<%=Const.Tooltips.FEEDBACK_QUESTION_DELETE%>">Delete </a>
					</span>
				</div>
				<div class="panel-body">
					<div>
						<textarea rows="5" class="form-control textvalue nonDestructive"
							name="questiontext" id="questiontext" data-toggle="tooltip"
							data-placement="top"
					...
					<div class="row">
						...
						<div class="col-sm-6 numberOfEntitiesElements">
							<label
								id="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES%>_text-"
								class="control-label col-sm-4 small"> The maximum number
								of <span
								id="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES%>_text_inner-"></span>
								each respondant should give feedback to:
							</label>
							<div class="col-sm-8 form-control-static">
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<input class="nonDestructive" type="radio"
										name="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIESTYPE%>"
										checked="checked" value="max"> <span class="">Unlimited</span>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12 text-muted visibilityMessage"></div>
					</div>
					<div class="visibilityOptions">
						<br>
						<table
							...
							<tr>
								...
								<td><input
									...
									name="receiverLeaderCheckbox" type="checkbox"
									value="<%=FeedbackParticipantType.RECEIVER%>" checked="checked" /></td>
								<td><input class="visibilityCheckbox giverCheckbox"
									type="checkbox" value="<%=FeedbackParticipantType.RECEIVER%>"
									checked="checked" /></td>
								<td><input class="visibilityCheckbox recipientCheckbox"
									name="receiverFollowerCheckbox" type="checkbox"
									value="<%=FeedbackParticipantType.RECEIVER%>"
							...
							<tr>
								...
								<td><input class="visibilityCheckbox answerCheckbox"
									type="checkbox"
									value="<%=FeedbackParticipantType.OWN_TEAM_MEMBERS%>" /></td>
								<td><input class="visibilityCheckbox giverCheckbox"
									type="checkbox"
									value="<%=FeedbackParticipantType.OWN_TEAM_MEMBERS%>" /></td>
								<td><input class="visibilityCheckbox recipientCheckbox"
							...
							<tr>
								...
								<td><input class="visibilityCheckbox answerCheckbox"
									type="checkbox"
									value="<%=FeedbackParticipantType.RECEIVER_TEAM_MEMBERS%>" /></td>
								<td><input class="visibilityCheckbox giverCheckbox"
									type="checkbox"
									value="<%=FeedbackParticipantType.RECEIVER_TEAM_MEMBERS%>" /></td>
								<td><input class="visibilityCheckbox recipientCheckbox"
					...
					<div>
						<span class="pull-right"> <input id="button_submit_add"
							type="submit" class="btn btn-primary" value="Save Question"
							tabindex="9">
						</span>
					</div>
				</div>
	...
	<input type="hidden"
		name="<%=Const.ParamsNames.FEEDBACK_QUESTION_NUMBER%>"
		value="<%=data.questions.size()+1%>">
	<input type="hidden"
		name="<%=Const.ParamsNames.FEEDBACK_SESSION_NAME%>"
		value="<%=data.session.feedbackSessionName%>">
	<input type="hidden" name="<%=Const.ParamsNames.COURSE_ID%>"
		value="<%=data.session.courseId%>">
	<input type="hidden"
		name="<%=Const.ParamsNames.FEEDBACK_QUESTION_SHOWRESPONSESTO%>">
	<input type="hidden"
		name="<%=Const.ParamsNames.FEEDBACK_QUESTION_SHOWGIVERTO%>">
			...
			<div class="modal-content">
				...
				<div class="modal-body padding-0">
					<form class="form" id="copyModalForm" role="form" method="post"
						...
						<!-- Previous Questions -->
						<table
							class="table-responsive table table-hover table-bordered margin-0"
							id="copyTableModal">
							<thead class="fill-primary">
								<th style="width: 30px;">&nbsp;</th>
								<th onclick="toggleSort(this,2);" id="button_sortid"
									class="button-sort-ascending">Course ID <span
									class="icon-sort sorted-ascending"></span>
								</th>
								<th onclick="toggleSort(this,3);" id="button_sortfsname"
									class="button-sort-none" style="width: 17%;">Session Name
									<span class="icon-sort unsorted"></span>
								</th>
								<th onclick="toggleSort(this,4);" id="button_sortfqtype"
									class="button-sort-none">Question Type <span
									class="icon-sort unsorted"></span>
								</th>
								<th onclick="toggleSort(this,5);" id="button_sortfqtext"
									class="button-sort-none">Question Text <span
									class="icon-sort unsorted"></span>
								</th>
							</thead>
						...
						<input type="hidden"
							name="<%=Const.ParamsNames.FEEDBACK_SESSION_NAME%>"
							value="<%=data.session.feedbackSessionName%>"> <input
							type="hidden" name="<%=Const.ParamsNames.USER_ID%>"
							value="<%=data.account.googleId%>"> <input type="hidden"
				...
				<div class="modal-footer margin-0">
					<button type="button" class="btn btn-primary"
						id="button_copy_submit" disabled="disabled">Copy</button>
		...
		<div class="well well-plain inputTable" id="questionPreviewTable">
			<div class="row">
				<form class="form-horizontal">
					<label class="control-label col-sm-2 text-right"> Preview
						Session: </label>
				</form>
				<div class="col-sm-5" data-toggle="tooltip" data-placement="top"
					title="<%=Const.Tooltips.FEEDBACK_PREVIEW_ASSTUDENT%>">
					<form method="post"
						action="<%=Const.ActionURIs.INSTRUCTOR_FEEDBACK_PREVIEW_ASSTUDENT%>"
						name="form_previewasstudent" class="form_preview" target="_blank">

						<div class="col-sm-6">
							<select class="form-control"
								name="<%=Const.ParamsNames.PREVIEWAS%>">
								<%
                                        for(StudentAttributes student : data.studentList) {
                                    %>
								<option value="<%=student.email%>">[<%=student.team%>]
									<%=student.name%></option>
								<%
                                        }
                                    %>
						...
						<input type="hidden"
							...
							value="<%=data.session.courseId%>">
						<div class="col-sm-6">
							<input id="button_preview_student" type="submit"
								class="btn btn-primary" value="Preview as Student"
				...
				<div class="col-sm-5" data-toggle="tooltip" data-placement="top"
					title="<%=Const.Tooltips.FEEDBACK_PREVIEW_ASINSTRUCTOR%>">
					<form method="post"
						action="<%=Const.ActionURIs.INSTRUCTOR_FEEDBACK_PREVIEW_ASINSTRUCTOR%>"
						name="form_previewasinstructor" class="form_preview"
						target="_blank">
						<div class="col-sm-6">
							<select class="form-control"
								name="<%=Const.ParamsNames.PREVIEWAS%>">
						...
						<input type="hidden"
							...
							value="<%=data.session.courseId%>">
						<div class="col-sm-6">
							<input id="button_preview_instructor" type="submit"
								class="btn btn-primary" value="Preview as Instructor">
						</div>
						<input type="hidden" name="<%=Const.ParamsNames.USER_ID%>"
							value="<%=data.account.googleId%>">
					</form>
