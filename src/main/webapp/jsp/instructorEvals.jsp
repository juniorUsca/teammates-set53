	...
	<div id="frameBodyWrapper" class="container theme-showcase">
		...
		<div class="well well-plain">
			<div class="row">
				...
				<div class="col-md-5">
					<select class="form-control" name="feedbackchangetype"
				...
				<div class="col-md-5">
					<h5>
						...
						<span class="text-muted"> Select a session type before
							filling out the form below.</span>
					</h5>
				</div>
			</div>
			<br>
			<form class="form-group" method="post"
				action="<%=Const.ActionURIs.INSTRUCTOR_EVAL_ADD%>"
				name="form_addevaluation">
				<div class="panel panel-primary">
					<div class="panel-body">
							...
							<div class="col-md-7">
								...
								<div class="row">
									<div class="form-group"
										...
										data-toggle="tooltip" data-placement="top">
										<h5 class="col-sm-4 ">
											<label for="<%=Const.ParamsNames.EVALUATION_NAME%>"
												class="control-label"> Evaluation name </label>
										</h5>
										<div class="col-md-7">
								...
								<div class="row"
									...
									data-toggle="tooltip" data-placement="top">
									<h5 class="col-md-4">
										<label for="" class="control-label"> Peer feedback </label>
									</h5>
									<div class="col-md-7">
										<div class="radio">
											<label for="commentsstatus_enabled">Enabled</label> <input
												type="radio"
												name="<%=Const.ParamsNames.EVALUATION_COMMENTSENABLED%>"
										...
										<div class="radio">
											<label for="commentsstatus_disabled">Disabled</label> <input
												type="radio"
												name="<%=Const.ParamsNames.EVALUATION_COMMENTSENABLED%>"
							...
							<div class="col-md-5 border-left-gray">
								<div class="row">
									<div class="form-group"
										...
										data-toggle="tooltip" data-placement="top">
										<h5 class="col-md-4">
											<label for="<%=Const.ParamsNames.EVALUATION_START%>"
												class="control-label"> Starting time </label>
										</h5>
										<div class="col-md-5">
											<input class="form-control" type="text"
								...
								<div class="row">
									<div class="form-group"
										...
										data-toggle="tooltip" data-placement="top">
										<h5 class="col-md-4">
											<label for="<%=Const.ParamsNames.EVALUATION_DEADLINE%>"
												class="control-label"> Closing time </label>
										</h5>
										<div class="col-md-5">
											<input class="form-control" type="text"
								...
								<div class="row">
									<div class="form-group"
										...
										data-toggle="tooltip" data-placement="top">
										<h5 class="col-md-4">
											<label for="<%=Const.ParamsNames.EVALUATION_GRACEPERIOD%>"
						...
						<div class="row"
							...
							data-toggle="tooltip" data-placement="top">
							<h5 class="col-md-2">
								<label for="<%=Const.ParamsNames.EVALUATION_INSTRUCTIONS%>"
							...
							<div class="col-md-10">
								...
								<textarea rows="3" class="form-control"
									...
									placeholder="Please submit your peer evaluation based on the overall contribution of your teammates so far.">Please submit your peer evaluation based on the overall contribution of your teammates so far.</textarea>
								<%
                                    } else {
                                %>
								<textarea rows="3" class="form-control"
									name="<%=Const.ParamsNames.EVALUATION_INSTRUCTIONS%>"
									id="<%=Const.ParamsNames.EVALUATION_INSTRUCTIONS%>"
									placeholder="Please submit your peer evaluation based on the overall contribution of your teammates so far."><%=InstructorEvalPageData.sanitizeForHtml(data.newEvaluationToBeCreated.instructions.getValue())%></textarea>
								<%
                                    }
                                %>
							</div>
						...
						<div class="row">
							<div class="col-md-12">
								<button type="submit" id="button_submit"
									...
									disabled="disabled">Create Evaluation Session</button>
							</div>
						</div>
					</div>
				</div>
		...
		<table class="table-responsive table table-striped table-bordered">
			...
			<tr class="sessionsRow" id="evaluation<%=sessionIdx%>">
				...
				<td><span
					title="<%=InstructorEvalPageData.getInstructorHoverMessageForEval(edd)%>"
					data-toggle="tooltip" data-placement="top"> <%=InstructorEvalPageData.getInstructorStatusForEval(edd)%>
				</span></td>
				<td
			...
			<tr class="sessionsRow" id="session<%=sessionIdx%>">
				...
				<td><span
					title="<%=InstructorEvalPageData.getInstructorHoverMessageForFeedbackSession(fdb)%>"
					data-toggle="tooltip" data-placement="top"> <%=InstructorEvalPageData.getInstructorStatusForFeedbackSession(fdb)%>
				</span></td>
				<td
