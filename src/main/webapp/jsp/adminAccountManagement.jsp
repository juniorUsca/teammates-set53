...
<body>
	...
	<div class="container theme-showcase" id="frameBodyWrapper" role="main">
		...
		<div id="headerOperation" class="page-header">
			<h1>
				Instructor Account Management<small id="instructorCount">Total
					Instructors: <%=data.instructorCoursesTable.size()%></small>
			</h1>
				...
				<table class="table table-striped dataTable">
					<thead>
						<tr>
							...
							<th width="20%" onclick="toggleSort(this,3)"
								class="button-sort-ascending">Institute <span
								class="icon-sort unsorted" id="button_sort_institute"></span>
							</th>
							<th width="30%" onclick="toggleSort(this,4);"
								class="button-sort-ascending">Create At <span
								class="icon-sort unsorted" id="button_sort_createat"></span>
							</th>
					...
					<tbody>
						...
						.displayDateTime(acc.createdAt)%></td>
							...
							<td><a id="<%=acc.googleId + "_details"%>"
								href="<%=data.getAdminViewAccountDetailsLink(acc.googleId)%>"
								target="blank" class="btn  btn-link btn-xs"> <span
									class="glyphicon glyphicon-info-sign"></span> View Details
							</a>&nbsp;&nbsp;&nbsp;&nbsp; <a id="<%=acc.googleId + "_delete"%>"
								href="<%=data.getAdminDeleteInstructorStatusLink(acc.googleId)%>"
								class="btn  btn-link btn-xs" role="button"> <span
									class="glyphicon glyphicon-remove"></span> Delete Instructor
									Status
							</a> <a id="<%=acc.googleId + "_deleteAccount"%>"
								...
								class="btn btn-link btn-xs "> <span
									class="glyphicon glyphicon-trash"></span> Delete Entire Account
							</a>
								...
								<form method="post" target="blank"
									...
									<button type="submit" id="<%=acc.googleId + "_recentActions"%>"
										...
										<span class="glyphicon glyphicon-zoom-in"></span> View Recent
										Actions
									</button>
