...
<body>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<h3 class="text-center">
			Previewing Session as Instructor
			<%=data.previewInstructor.name%>
			(<%=data.previewInstructor.email%>)
		</h3>
	</nav>
	<% 
        }
	...
	<div id="frameBodyWrapper" class="container">
		...
		<form method="post"
			action="<%=Const.ActionURIs.INSTRUCTOR_FEEDBACK_SUBMISSION_EDIT_SAVE%>"
			name="form_submit_response">
            ...
            %>
				<input disabled="disabled" type="submit"
					class="btn btn-primary center-block" id="response_submit_button"
