...
<script type="text/javascript"
	src="/js/instructorFeedbackResultsAjaxByGQR.js"></script>
<script type="text/javascript"
	...
	<div class="panel panel-success">
        ...
        %>
				<div class="panel panel-warning">
					<div class="panel-heading">
						<strong><%=currentTeam%></strong> <span
						...
						<div class="panel-body background-color-warning">
                            ...
                            %>
								...
								<div class="panel panel-info">
									<div class="panel-heading">
										<strong>Question <%=teamResponseEntries.getKey().questionNumber%>:
										</strong><span class="text-preserve-space"><%=data.bundle.getQuestionText(teamResponseEntries.getKey().getId())%>
											<%
							...
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<div class="middlealign profile-pic-icon-hover inline"
										...
										<a class="link-in-dark-bg" href="mailTo:<%= giverEmail%> "
											<%=mailtoStyleAttr%>>[<%=giverEmail%>]
										</a>
									</div>
									<% } else {%>
									<strong><%=responsesFromGiver.getKey()%></strong> <a
										class="link-in-dark-bg" href="mailTo:<%= giverEmail%> "
										<%=mailtoStyleAttr%>>[<%=giverEmail%>]
									</a>
									<% } %>
									<span
                ...
                %>
                                    ...
                                    out.print(questionDetails.getQuestionAdditionalInfoHtml(question.questionNumber, "giver-"+giverIndex+"-question-"+questionIndex));%>
											...
											<div class="panel-body padding-0">
												...
												<table
													class="table table-striped table-bordered dataTable margin-0">
													<thead
                                        ...
                                        %>
															<td class="middlealign">
																<div class="profile-pic-icon-click align-center"
																	data-link="<%=data.getProfilePictureLink(responseEntry.recipientEmail)%>">
																	<a class="student-profile-pic-view-link btn-link">
																		View Photo </a> <img src="" alt="No Image Given"
																		class="hidden">
																</div>
															</td>
															<% } else { %>
