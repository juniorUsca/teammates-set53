		...
		<div class="well well-plain">
			<form class="form-group" method="post"
				...
				<div class="row">
						...
						<div class="col-md-10" title="Select a session type here."
							...
							<select class="form-control"
								...
								<option value="STANDARD"
									<%= (data.feedbackSessionType != null && data.feedbackSessionType.equals("STANDARD")) ? "selected=\"selected\"" : "" %>>
									Session with your own questions</option>
								<option value="TEAMEVALUATION"
									<%= (data.feedbackSessionType == null || data.feedbackSessionType.equals("TEAMEVALUATION")) ? "selected=\"selected\"" : "" %>>
									Team peer evaluation session</option>
							</select>
						</div>
						<div class="col-md-1">
							<h5>
								<a href="/instructorHelp.html#fbSetupSession" target="_blank"><span
					...
					<div class="col-md-3">
						<a id="button_copy" class="btn btn-info"
							style="vertical-align: middle;">Copy from previous feedback
							sessions</a>
					</div>
				</div>
				<br>
								...
								<div class="form-group">
									<h5 class="col-sm-2">
										<label for="<%=Const.ParamsNames.FEEDBACK_SESSION_NAME%>"
											class="control-label">Session name</label>
									</h5>
									<div class="col-sm-10">
				...
				<div class="row" id="uncommonSettingsInfo">
					<div class="col-md-12 text-muted">
						<span id="uncommonSettingsInfoText"> </span> <a
							...
							data-done="[Done]">[Edit]</a> <br> <br>
					</div>
				</div>
				<div class="panel panel-primary" style="display: none;"
					id="sessionResponsesVisiblePanel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-6">
								<div class="row">
								...
								<div class="row radio">
									<div class="col-md-6"
										...
										<label
											...
											(this is a private session)</label> <input type="radio"
											name="<%=Const.ParamsNames.FEEDBACK_SESSION_SESSIONVISIBLEBUTTON%>"
								...
								<div class="row radio">
									<div class="col-md-4"
										...
										<label
											...
											manually</label> <input type="radio" name="resultsVisibleFromButton"
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-sm-3"
								...
								data-toggle="tooltip" data-placement="top">
								<div class="checkbox">
									<label>Session opening reminder</label> <input type="checkbox"
										checked="checked"
							...
							<div class="col-sm-3"
								...
								<div class="checkbox">
									<label
										...
										closing reminder</label> <input type="checkbox" checked="checked"
										name="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>"
							...
							<div class="col-sm-4"
								...
								<div class="checkbox">
									<label
										...
										published announcement</label> <input type="checkbox"
										checked="checked"
										name="<%=Const.ParamsNames.FEEDBACK_SESSION_SENDREMINDEREMAIL%>"
		...
		<table class="table-responsive table table-striped table-bordered">
			<thead>
				<tr class="fill-primary">
					...
					<th>Status</th>
					<th><span title="<%=Const.Tooltips.EVALUATION_RESPONSE_RATE%>"
			...
			<tr class="sessionsRow" id="session<%=sessionIdx%>">
				...
				<td><span
					title="<%=InstructorFeedbacksPageData.getInstructorHoverMessageForFeedbackSession(fdb)%>"
					data-toggle="tooltip" data-placement="top"> <%=InstructorFeedbacksPageData.getInstructorStatusForFeedbackSession(fdb)%>
				</span></td>
				<td
			...
			<tr class="sessionsRow" id="evaluation<%=sessionIdx%>">
				...
				<td><span
					title="<%=InstructorFeedbacksPageData.getInstructorHoverMessageForEval(edd)%>"
					data-toggle="tooltip" data-placement="top"> <%=InstructorFeedbacksPageData.getInstructorStatusForEval(edd)%>
				</span></td>
				<td
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="copyModalTitle">Creating a new
							session by copying a previous session</h4>
					</div>
					<div class="modal-body">
						<form class="form" id="copyModalForm" role="form" method="post"
							...
							<!-- Course -->
							<div class="form-group">
								<label for="modalCopiedCourseId" class="control-label">Create
									in course</label> <select class="form-control"
							...
							<!-- Session Name -->
							<div class="form-group">
								<label for="modalCopiedSessionName" class="control-label">Name
									for new session</label> <input class="form-control" type="text"
							...
							<table
								class="table-responsive table table-bordered table-hover margin-0"
								id="copyTableModal">
                        ...
                        %>
							...
							<input type="hidden"
								name="<%=Const.ParamsNames.FEEDBACK_SESSION_NAME%>" value=""
								id="modalSessionName"> <input type="hidden"
								name="<%=Const.ParamsNames.COURSE_ID%>" value=""
								id="modalCourseId"> <input type="hidden"
