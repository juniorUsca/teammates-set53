	...
	<div id="frameBodyWrapper" class="container theme-showcase">
		...
		<ul class="pagination">
			...
			<%
                ...
                %>
			<li class="<%=courseId.equals(data.courseId) ? "active" : ""%>">
				<a
		...
		<div class="well well-plain">
			...
			<div id="no-comment-panel"
				style="<%=data.comments.size() == 0 && data.feedbackResultBundles.keySet().size() == 0?"":"display:none;"%>">
				<br>
				<div class="panel">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<%
                        ...
                        %>
					<div
						class="panel panel-info student-record-comments <%=recipientDisplay.equals("you")?"giver_display-to-you":"giver_display-to-others"%>">
						<div class="panel-heading">
							...
							<li class="list-group-item list-group-item-warning"
								...
								<div id="commentBar-<%=commentIdx%>">
									...
									<span class="text-muted">From <b><%=giverDisplay%></b>
										on <%=TimeHelper.formatDate(comment.createdAt)%></span>
								</div>
