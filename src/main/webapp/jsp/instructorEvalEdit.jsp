		...
		<div class="panel panel-primary">
			...
			<div class="panel-body fill-plain">
				<form class="form-horizontal" role="form"
					action="<%=Const.ActionURIs.INSTRUCTOR_EVAL_EDIT_SAVE%>"
					...
					<div class="col-md-7">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<p class="form-control-static"
										...
										id="<%=Const.ParamsNames.COURSE_ID%>"><%=data.evaluation.courseId%>
									</p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label"> Evaluation name:
								</label>
								<div class="col-sm-7">
									<p class="form-control-static"
						...
						<div class="row">
							<div class="form-group">
								<label class="col-sm-4 control-label">Peer feedback:</label>
								<div class="col-sm-8">
									<div class="radio">
					...
					<div class="col-md-5 border-left-gray">
                      ...
                      %>
                       ...
                       %>
						...
						<div class="row">
							<div class="form-group">
								<label class="col-sm-4 control-label">Grace period:</label>
								<div class="col-md-4">
									<select class="form-control inline"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea rows="5" class="form-control"
								...
								style="max-width: 100%;" data-toggle="tooltip"
								data-placement="top"
					...
					<input type="hidden" name="<%=Const.ParamsNames.USER_ID%>"
						id="<%=Const.ParamsNames.USER_ID%>"
						value="<%=data.account.googleId%>"> <input type="hidden"
						name="<%=Const.ParamsNames.COURSE_ID%>"
						id="<%=Const.ParamsNames.COURSE_ID%>"
						value="<%=data.evaluation.courseId%>"></input> <input
						type="hidden" name="<%=Const.ParamsNames.EVALUATION_NAME%>"
						id="<%=Const.ParamsNames.EVALUATION_NAME%>"
						value="<%=InstructorEvalEditPageData.sanitizeForHtml(data.evaluation.name)%>"></input>
