		...
		<div class="panel panel-primary panel-narrow">
			...
			<div class="panel-body">
				<p class="lead">
					...
					<br>If this is not you please <a href="/logout.jsp">log
				...
				<div class="align-center">
                    ...
                    %>
					<a href="<%=ref%>" id="button_confirm" class="btn btn-success">Yes,
						this is my account</a> <a href="/logout.jsp" id="button_cancel"
