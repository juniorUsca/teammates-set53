...
<body>
	...
	<div class="container" id="frameBodyWrapper">
		...
		<div class="well well-plain">
			<form class="form-horizontal" role="form" id="download_eval_report"
				method="GET"
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-5">
						<label class="radio-inline" style="margin-left: 10px;"> <input
							type="radio" name="radio_reporttype" id="radio_summary"
							value="instructorEvaluationSummaryTable" checked="checked"
							onclick="showReport(this.value)"> Summary
						</label> <label class="radio-inline"> <input type="radio"
							name="radio_reporttype" id="radio_reviewer"
							value="instructorEvaluationDetailedReviewerTable"
							onclick="showReport(this.value)"> Detailed: By Reviewer
						</label> <label class="radio-inline"> <input type="radio"
							name="radio_reporttype" id="radio_reviewee"
							value="instructorEvaluationDetailedRevieweeTable"
							onclick="showReport(this.value)"> Detailed: By Reviewee
						</label>
					</div>
				</div>
				<br>
				<div class="form-group">
					<div
						class="col-sm-offset-4 col-sm-2 col-xs-offset-2 col-xs-3 col-md-offset-5 col-md-1">
						<%
						...
						<button type="button" class="btn btn-primary"
							id="button_unpublish" value="Unpublish"
					...
					<div class="col-sm-2 col-xs-4">
						<button type="submit" value="Download Report"
					...
					<input type="hidden" name="<%=Const.ParamsNames.USER_ID%>"
						...
						value="<%=data.evaluationResults.evaluation.courseId%>"> <input
						type="hidden" name="<%=Const.ParamsNames.EVALUATION_NAME%>"
				...
				<div class="col-sm-4">
					<h4>
						<span class="label label-info" data-toggle="tooltip"
							...
							title='<%=Const.Tooltips.CLAIMED%>'>CC</span> Claimed
						Contribution
					</h4>
				</div>
				<div class="col-sm-5">
					<h4>
						<span class="label label-info" data-toggle="tooltip"
							data-placement="top" data-container="body"
							title='<%=Const.Tooltips.PERCEIVED%>'>PC</span> Perceived
						Contribution
					</h4>
				</div>
				<div class="col-sm-3">
					<h4>
						<span class="label label-info">E</span> Equal Share
					</h4>
				</div>
			</div>
			<div class="pull-right">
				[<a href="/instructorHelp.html#faq7a" target="_blank"
					id="interpret_help_link">How do I interpret/use these values?</a> ]
			</div>

			<table class="table table-bordered table-striped" id="dataTable">
				<thead class="fill-primary">
					<tr>
						<th class="button-sort-none" id="button_sortteamname"
							onclick="toggleSort(this,1);">Team <span
							class="icon-sort unsorted"></span></th>
						<th class="button-sort-none" id="button_sortname"
							onclick="toggleSort(this,2)">Student <span
							class="icon-sort unsorted"></span></th>
						<th class="button-sort-none" id="button_sortclaimed"
							onclick="toggleSort(this,3,sortByPoint)">CC <span
							class="icon-sort unsorted"></span>
						</th>
						<th class="button-sort-none" id="button_sortperceived"
							onclick="toggleSort(this,4,sortByPoint)">PC <span
							class="icon-sort unsorted"></span>
						</th>
						<th class="button-sort-none" id="button_sortdiff"
							onclick="toggleSort(this,5,sortByDiff)" data-toggle="tooltip"
							data-placement="top" data-container="body"
							title='<%=Const.Tooltips.EVALUATION_DIFF%>'>Diff <span
							class="icon-sort unsorted"></span>
						</th>
						<th class="align-center" data-toggle="tooltip"
							data-placement="top" data-container="body"
							title='<%=Const.Tooltips.EVALUATION_POINTS_RECEIVED%>'>Ratings
							Received</th>
				...
				<tr class="student_row" id="student<%=idx%>">
					...
					<td id="<%=Const.ParamsNames.STUDENT_NAME%>" data-toggle="tooltip"
						data-placement="top" data-container="body"
		...
		<div
					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-md-4">
								<div class="pull-right">
									<span data-toggle="tooltip" data-placement="top"
										data-container="body" title='<%=Const.Tooltips.CLAIMED%>'>
							...
							<div class="col-md-4">
								<div class="pull-right">
									<span data-toggle="tooltip" data-placement="top"
										data-container="body" title='<%=Const.Tooltips.PERCEIVED%>'>
							...
							<div class="col-md-1">
								<div class="pull-right">
									...
									<a target="_blank" class="button btn-primary btn-xs"
										...
										onclick="return openChildWindow(this.href)"><span
			...
			<div class="align-center">
				<button class="btn btn-info btn-circle" value="To Top"
					onclick="scrollToTop()">
