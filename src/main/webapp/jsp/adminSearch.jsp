			...
			<div id="frameBodyWrapper">
					...
					<form class="form-horizontal" method="get" action=""
						...
						<div class="panel-heading" id="filterForm">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-12">
										<span class="help-block">Tips: Surround key word to
											search a whole string or string contains punctuation like "-"
											"."</span>
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<strong>Instructors Found </strong> <span class="pull-right"><button
							...
							<tbody>
								...
								<tr id="<%=id%>" class="instructorRow">
									...
									<td><a
										...
										target="blank" class="homePageLink"><%=instructor.googleId == null? "" : instructor.googleId%></a>
									</td>
									...
									<td colspan="5">
										<ul class="list-group">
											<li
												...
												<strong>Email</strong> <input value="<%=instructor.email%>"
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<strong>Students Found </strong> <span class="pull-right"><button
								class="btn btn-primary btn-xs" type="button"
								onclick="adminSearchDiscloseAllStudents()">Disclose All</button>
							<button class="btn btn-primary btn-xs" type="button"
								onclick="adminSearchCollapseAllStudents()">Collapse All</button></span>
					</div>
					...
					<div class="table-responsive">
						<table class="table table-striped dataTable" id="search_table">
                            ...
                            .get(student.googleId)%>"
										target="blank" class="homePageLink"><%=student.googleId%></a>
									</td>
								...
								<tr
									...
									<td colspan="5">
										<ul class="list-group">
											...
											<li
												class="list-group-item list-group-item-success has-success">
												<strong>Email</strong> <input value="<%=student.email%>"
												readonly="readonly" class="form-control" />
											</li>
											<%
                                                }
											...
											<li class="list-group-item list-group-item-info"><strong>Course
													Join Link</strong> <input value="<%=student.getRegistrationUrl()%>"
												readonly="readonly" class="form-control" /></li>
											...
											<li class="list-group-item list-group-item-warning"><strong>
													<%=data.feedbackSeesionLinkToNameMap
                                    .get(link)%>
											</strong> <input value=<%=link%> readonly="readonly"
