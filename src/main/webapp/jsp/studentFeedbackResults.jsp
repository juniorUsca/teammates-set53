		...
		<div id="frameBodyWrapper" class="container">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4>
						Question
						<%=qnIndx%>: <span class="text-preserve-space"><%=StudentFeedbackResultsPageData.sanitizeForHtml(questionDetails.questionText)%><%=questionDetails.getQuestionAdditionalInfoHtml(qnIndx, "")%></span>
					</h4>
					<%=
					...
					<div class="panel panel-primary">
                        ...
                        %>
								<tr class="resultSubheader">
									<td><span class="bold"><b>From:</b></span> <%=giverName%></td>
								</tr>
								<tr>
            ...
            %>
			<div class="col-sm-12" style="color: red">There are currently
				no responses for you for this feedback session.</div>
			<% 
                } 
            %>
		</div>
