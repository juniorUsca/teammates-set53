	...
	<div id="frameBodyWrapper" class="container">
		...
		<div class="well well-plain inputTable" id="studentEvaluationInfo">
			<form class="form-horizontal" role="form">
				<div class="panel-heading">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"> Evaluation Name: </label>
						<div class="col-sm-10">
		...
		<div class="panel panel-primary resultsTable">
			<div class="panel-heading">
				<div class="row">
					<div class="col-md-4">
						<span class="resultHeader"> <%=byReviewee ? "Reviewee" : "Reviewer"%>:
						</span> <strong> <%=data.student.name%>
						</strong>
					</div>
					<div class="col-md-4">
						<span class="resultHeader" title="<%=Const.Tooltips.CLAIMED%>"
							data-toggle="tooltip" data-placement="top"> Claimed
							Contribution: </span>
						<%=InstructorEvalSubmissionPageData.getPointsInEqualShareFormatAsHtml(data.studentResult.summary.claimedToInstructor,true)%>
					</div>
					<div class="col-md-4">
						<span class="resultHeader" title="<%=Const.Tooltips.PERCEIVED%>"
							data-toggle="tooltip" data-placement="top"> Perceived
							Contribution: </span>
			...
			<table class="table table-bordered">
				<tbody>
					<tr>
						<td><strong> Self evaluation: </strong> <br> <%=InstructorEvalSubmissionPageData.getJustificationAsSanitizedHtml(data.studentResult.getSelfEvaluation())%></td>
					</tr>
					<tr>
						<td><strong> Comments about team: </strong> <br> <%=InstructorEvalSubmissionPageData.sanitizeForHtml(data.studentResult.getSelfEvaluation().p2pFeedback.getValue())%></td>
					</tr>
				</tbody>
			</table>
		...
		<div class="col-sm-12">
			<input type="button" class="btn btn-primary center-block"
				id="button_edit" value="Edit Submission"
