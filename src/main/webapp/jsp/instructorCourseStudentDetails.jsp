	...
	<div class="container theme-showcase" id="frameBodyWrapper">
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title"><%=data.student.name%>'s Profile -
							More Info
						</h4>
					</div>
		...
		<div class="well well-plain">
			<button type="button"
				...
				title="" data-original-title="Add comment"
		...
		<div id="commentArea" class="well well-plain" style="display: none;">
			<form method="post"
				...
				<p class="form-group text-muted">The default visibility for your
					comment is private. You may change it using the visibility options
					above.</p>
						...
						<tbody>
							...
							<tr id="recipient-person">
								...
								<td><input class="visibilityCheckbox recipientCheckbox"
									...
									value="<%=CommentRecipientType.PERSON%>" disabled="disabled"></td>
							</tr>
							...
							<tr id="recipient-section">
								...
								<td><input class="visibilityCheckbox answerCheckbox"
									type="checkbox" value="<%=CommentRecipientType.SECTION%>">
								</td>
								<td><input class="visibilityCheckbox giverCheckbox"
									type="checkbox" value="<%=CommentRecipientType.SECTION%>">
								</td>
				...
				<div style="text-align: center;">
					<input type="submit" class="btn btn-primary"
						...
						value="<%=data.student.course%>"> <input type="hidden"
						name=<%=Const.ParamsNames.STUDENT_EMAIL%>
						value="<%=data.student.email%>"> <input type="hidden"
					...
					<input type="hidden" name="<%=Const.ParamsNames.USER_ID%>"
						...
						name="<%=Const.ParamsNames.FROM_STUDENT_DETAILS_PAGE%>"
						value="true">
				</div>
			</form>
		</div>
