		...
		<div class="panel panel-primary panel-narrow">
			...
			<div class="panel-body">
				<p>
					...
					<br>If this is not you please <a href="<%=data.logoutUrl%>">log
						out</a> and re-login using your own Google account. <br>If this
					is you, please confirm below to complete your registration. <br>
				</p>
				<div class="align-center">
					<a href="<%=data.confirmUrl%>" class="btn btn-success"
						id="button_confirm">Yes, this is my account</a> <a
						href="<%=data.logoutUrl%>" class="btn btn-danger"
