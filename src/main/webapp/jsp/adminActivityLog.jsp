		...
		<div id="frameBody">
						...
						<div class="panel-heading" id="filterForm">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="input-group">
											...
											</span> <input type="text" class="form-control" id="filterQuery"
												name="filterQuery" value="<%=data.filterQuery%>">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<a href="#" class="btn btn-link center-block"
									onclick="toggleReference()"><span id="referenceText">
										Show Reference</span><br> <span
									class="glyphicon glyphicon-chevron-down" id="detailButton"></span>
								</a>
							...
							<div id="filterReference">
								<div class="form-group">
									...
									<div class="col-md-12">
										<h4 class="text-center">
											<span class="label label-primary">Append "?all=true"
												to URL to show all logs, omit to exclude following requests.
											</span>
										</h4>
										<div class="text-center">
											<ul class="list-group">
												<li class="list-group-item">instructorEvalStatsPage</li>
											</ul>
										</div>
										...
										<div class="alert alert-success">
											<p class="text-center">
												<span class="glyphicon glyphicon-filter"></span> A query is
												formed by a list of filters. Each filter is in the format <strong>&nbsp;[filter
													label]: [value1, value2, value3....]</strong><br>
											</p>
										</div>


										<p class="text-center">
											<span class="glyphicon glyphicon-hand-right"></span> Combine
											filters with the <span class="label label-warning">
								...
								<small>
									<div class="form-group">
										<div class="col-md-12">
											...
											<div class="form-control-static">
												...
												<ul>
													<li>E.g. role: Instructor AND request:
														InstructorCourse, InstructorEval AND from: 15/03/13</li>
													<li>E.g. from: 13/3/13 AND to: 17/3/13 AND person:
														teammates.test AND response: Pageload, System Error
														Report, Servlet Action Failure</li>
												</ul>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-md-12">
											...
											<div class="form-control-static">
												...
												<strong> Possible Labels:</strong>&nbsp;from, to, person,
												role, request, response, version,time<br>
												<ul>
													...
													<li>E.g. role: Instructor, Student</li>
													<li>E.g. request: InstructorEval, StudentHome,
														evaluationclosingreminders</li>
													<li>E.g. response: Pageload, System Error Report,
														Delete Course</li>

													<li>E.g. version: 4.15, 4.16</li>

													<li>E.g. version: 4-15, 4.16 (both "." and "-" are
														acceptable)</li>
									...
									<div class="form-group">
										<div class="col-md-12">
											<p class="form-control-static">
												<strong> Possible Roles: </strong> Instructor, Student,
												Unknown
									...
									<div class="form-group">
										<div class="col-md-12">
											<p class="form-control-static">
												<strong> Possible Servlets Requests: </strong> <br> <br>
											...
											<div class="table-responsive">
												...
												<table class="table table-condensed">
													...
													<tr>
														<td>
															<ul class="list-group">
																<li class="list-group-item">Remind Students About
																	Evaluation</li>
																<li class="list-group-item">Send Evaluation Closing
																	reminders</li>
																<li class="list-group-item">Send Evaluation Opening
																	reminders</li>
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<strong>Activity Log <span> Instructor </strong>
				</div>
				<div class="table-responsive">
			...
			<br> <a href="#" class="back-to-top-left"><span
				class="glyphicon glyphicon-arrow-up"></span>&nbsp;Top</a> <a href="#"
				class="back-to-top-right">Top&nbsp;<span
