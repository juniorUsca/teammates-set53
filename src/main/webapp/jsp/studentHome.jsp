...
<body>
	...
	<div id="frameBodyWrapper" class="container theme-showcase">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="checkbox">
					<input id="displayArchivedData_check" type="checkbox"
						<%if(data.displayArchive){%> checked="checked" <%}%>> <label
						for="displayArchivedData_check">Display archived data</label>
				</div>
			</div>
		</div>
		<!-- </div> -->
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				</strong> <span class="pull-right"> <a class="btn btn-primary btn-xs"
					href="<%=data.getStudentCourseDetailsLink(courseDetails.course.id)%>"
					data-toggle="tooltip" data-placement="top"
					title="<%=Const.Tooltips.STUDENT_COURSE_DETAILS%>">View Team</a>
				</span>
			</div>
            ...
            %>
				...
				<tr id="evaluation<%=sessionIdx%>">
					...
					<td class="studentHomeActions"><%=data.getStudentEvaluationActions(edd.evaluation,sessionIdx)%>
					</td>
				</tr>
				<%
                            } else {
				...
				<%
                    ...
                    %>
				<tr>
					<th class="align-center bold color_white">Currently, there are
						no open evaluation/feedback sessions in this course. When a
						session is open for submission you will be notified.</th>
				</tr>
				<%
                        }
                    %>
