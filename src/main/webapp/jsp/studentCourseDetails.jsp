...
<body>
	...
	<div class="container" id="frameBodyWrapper">
		...
		<div id="headerOperation">
			<h1>
				Team Details for
				<%=data.courseDetails.course.id%></h1>
		</div>
		<br>
		...
		<div class="well well-plain">
			<div class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<p class="form-control-static"
							id="<%=Const.ParamsNames.TEAMMATES%>">
							<%
                                if(data.team==null || data.team.students.size()==1){
                            %>
							<span style="font-style: italic;"> You have no team
								members or you are not registered in any team </span>
							<%
                                } else {
                            %>
                            ...
                            %>
							<a href="mailto:<%=student.email%>"> <%=PageData.sanitizeForHtml(student.name)%>
							</a><br>
							<%
                                }
                            %>
