	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="contentLinks">
			...
			<ul class="nav navbar-nav">
				...
				<li
					class="<%=data.getClass().toString()
                    .contains("AdminEstadisticasPage") ? "active" : ""%>">
					<a href="<%=Const.ActionURIs.ADMIN_ESTADISTICAS_PAGE%>">Estadisticas</a>
				</li>
			...
			<ul class="nav navbar-nav pull-right">
				<li><a class="nav logout" href="<%=Const.ViewURIs.LOGOUT%>">
                    ...
                    %> (<span class="text-info" data-toggle="tooltip"
						data-placement="bottom" title="<%=data.account.googleId%>">
							<%=PageData.truncate(data.account.googleId,
