							...
							<div
								...
								<form class="responseCommentDeleteForm pull-right">
									<a
										...
										value="<%=frc.feedbackResponseId%>"> <input
										type="hidden"
										name="<%=Const.ParamsNames.FEEDBACK_RESPONSE_COMMENT_ID%>"
										value="<%=frc.getId()%>"> <input type="hidden"
										name="<%=Const.ParamsNames.COURSE_ID%>"
										value="<%=responseEntry.courseId%>"> <input
										type="hidden"
										name="<%=Const.ParamsNames.FEEDBACK_SESSION_NAME%>"
										value="<%=responseEntry.feedbackSessionName%>"> <input
								...
								<a type="button"
									...
									data-toggle="tooltip" data-placement="top"
									title="<%=Const.Tooltips.COMMENT_EDIT%>" style="display: none;">
								...
								<div class="form-group">
									<div class="form-group form-inline">
										...
										<a
											...
											<span class="glyphicon glyphicon-eye-close"></span> Show
											Visibility Options
										</a>
									</div>
									<div
							...
							<form class="responseCommentAddForm">
								...
								<div class="col-sm-offset-5">
									...
									<input type="hidden" name="<%=Const.ParamsNames.COURSE_ID%>"
										...
										value="<%=responseEntry.feedbackQuestionId%>"> <input
										type="hidden"
										name="<%=Const.ParamsNames.FEEDBACK_RESPONSE_ID%>"
										value="<%=responseEntry.getId()%>"> <input
										type="hidden" name="<%=Const.ParamsNames.USER_ID%>"
										value="<%=data.account.googleId%>"> <input
										type="hidden"
										name="<%=Const.ParamsNames.RESPONSE_COMMENTS_SHOWCOMMENTSTO%>"
...
<div id="no-comment-panel" style="">
	...
	<div class="panel panel-info">
		<ul class="list-group comments">
			<li class="list-group-item list-group-item-warning">You don't
				have any comment in this session.</li>
		</ul>
	</div>
</div>
<% } %>