...
<body>
	<div class="container theme-showcase">
		<div class="row">
					...
					<tr>
						<td>
							...
							<ul class="nav">
								...
								<li><a href="#instructorAddCoursePage">Instructor Add
										Course Page</a></li>
								<li><a href="#instructorEditCoursePage">Instructor Edit
										Course Page</a></li>
								<li><a href="#instructorEnrollPage">Instructor Enroll
										Students Page</a></li>
								<li><a href="#instructorCourseDetailsPage">Instructor
										Course Details Page</a></li>
								<li><a href="#instructorStudentListPage">Instructor
										Student List Page</a></li>
								<li><a href="#instructorCourseStudentDetailsPage">Instructor
										Student Details Page</a></li>
								<li><a href="#instructorCourseStudentEditPage">Instructor
										Student Edit Page</a></li>
								<li><a href="#instructorStudentRecordsPage">Instructor
										Student Records Page</a></li>
								<li><a href="#instructorCourseEvalPage">Instructor Eval
										Page</a></li>
								<li><a href="#instructorCourseEvalEditPage">Instructor
										Eval Edit Page</a></li>
								<li><a href="#instructorCourseEvalPreviewPage">Instructor
										Eval Preview Page</a></li>
								<li><a href="#instructorCourseEvalResultsPage1">Instructor
										Eval Results Page (instructorEvaluationSummaryTable)</a></li>
								<li><a href="#instructorCourseEvalResultsPage2">Instructor
										Eval Results Page (instructorEvaluationDetailedReviewerTable)</a></li>
								<li><a href="#instructorCourseEvalResultsPage3">Instructor
										Eval Results Page (instructorEvaluationDetailedRevieweeTable)</a></li>
								<li><a href="#instructorCourseEvalSubmissionViewPage">Instructor
										Eval Submission View Page</a></li>
								<li><a href="#instructorCourseEvalSubmissionEditPage">Instructor
										Eval Submission Edit Page</a></li>
								<li><a href="#instructorFeedbackPage">Instructor
										Feedback Page</a></li>
								<li><a href="#instructorFeedbackEditPage">Instructor
										Feedback Edit Page</a></li>
								<li><a href="#instructorFeedbackPreviewAsStudentPage">Instructor
										Feedback Preview as Student Page</a></li>
								<li><a href="#instructorFeedbackPreviewAsInstructorPage">Instructor
										Feedback Preview as Instructor Page</a></li>
								<li><a href="#instructorFeedbackSubmitPage">Instructor
										Feedback Submit Page</a></li>
								<li><a href="#instructorFeedbackQuestionSubmitPage">Instructor
										Feedback Question Submit Page</a></li>
								<li><a
									href="#instructorFeedbackResultsPageByGiverRecipientQuestion">Instructor
										Feedback Results Page (By giver-recipient-question)</a></li>
								<li><a
									href="#instructorFeedbackResultsPageByRecipientGiverQuestion">Instructor
										Feedback Results Page (By recipient-giver-question)</a></li>
								<li><a
									href="#instructorFeedbackResultsPageByGiverQuestionRecipient">Instructor
										Feedback Results Page (By giver-question-recipient)</a></li>
								<li><a
									href="#instructorFeedbackResultsPageByRecipientQuestionGiver">Instructor
										Feedback Results Page (By recipient-question-giver)</a></li>
								<li><a href="#instructorFeedbackResultsPageByQuestion">Instructor
										Feedback Results Page (By question)</a></li>
								<li><a href="#instructorCommentsPage">Instructor
										Comments Page</a></li>
								<li><a href="#instructorSearchPage">Instructor Search
										Page</a></li>
							</ul>
						</td>
						<td>
							...
							<ul class="nav">
								...
								<li><a href="#studentCourseJoinConfirmationPage">Student
										Course Join Confirmation Page</a></li>
								<li><a href="#studentCourseJoinConfirmationPageNew">Student
										Course Join Confirmation Page (New)</a></li>
								<li><a href="#studentCourseDetailsPage">Student Course
										Details Page</a></li>
								<li><a href="#studentEvalEditPage">Student Eval Edit
										Page</a></li>
								<li><a href="#studentEvalResultsPage">Student Eval
										Results Page</a></li>
								<li><a href="#studentFeedbackSubmitPage">Student
										Feedback Submit Page</a></li>
								<li><a href="#studentFeedbackQuestionSubmitPage">Student
										Feedback Question Submit Page</a></li>
								<li><a href="#studentFeedbackResultsPage">Student
										Feedback Results Page</a></li>
								<li><a href="#studentCommentsPage">Student Comments
										Page</a></li>
								<!-- ---------------- Modificaciones-------------------------- -->
								<li><a href="#studentCoursesPage">Student Courses Page</a></li>
								<!-- ----------------FIN Modificaciones-------------------------- -->
						...
						<td>
							...
							<ul class="nav">
								...
								<li><a href="#adminActivityLogPage">Admin Activity Log
										Page</a></li>
							</ul>
						</td>
						<td>
						...
						<td>
							<h2>Error Pages</h2>
							<ul class="nav">
								<li><a href="#deadlineExceededErrorPage">Deadline
										Exceeded Error Page</a></li>
			...
			<div class="pageinfo">Instructor Eval Results Page
				(instructorEvaluationSummaryTable)</div>
			...
			<div class="pageinfo">Instructor Eval Results Page
				(instructorEvaluationDetailedReviewerTable)</div>
			...
			<div class="pageinfo">Instructor Eval Results Page
				(instructorEvaluationDetailedRevieweeTable)</div>
			...
			<div class="pageinfo">Instructor Feedback Preview as Student
				Page</div>
			...
			<div class="pageinfo">Instructor Feedback Preview as Instructor
				Page</div>
			...
			<div class="pageinfo">Instructor Feedback Results Page (By
				giver-recipient-question)</div>
			...
			<div class="pageinfo">Student Course Join Confirmation Page
				(New)</div>
			...
			<br>
			<!--    -------------Modificacion-------------------------  -->
			<div class="pageinfo">Student Courses Page</div>
			<div id="studentCoursessPage"></div>
			<br></br> <br></br> <br></br> <br></br> <br>
			<hr class="hr-bold">
			<br>
			<!--    -------------Modificacion-------------------------  -->
			...
			<div id="index">
				<iframe class="full-width" src="../index.html"
					onLoad="calcHeight(this);"></iframe>
			</div>
			<div class="pageinfo">Features Page</div>
			<div id="features">
				<iframe class="full-width" src="../features.html"
					onLoad="calcHeight(this);"></iframe>
			</div>
			<div class="pageinfo">About Us Page</div>
			<div id="about">
				<iframe class="full-width" src="../about.html"
					onLoad="calcHeight(this);"></iframe>
			</div>
			<div class="pageinfo">Contact Page</div>
			<div id="contact">
				<iframe class="full-width" src="../contact.html"
					onLoad="calcHeight(this);"></iframe>
			</div>
			<div class="pageinfo">Terms Of Use Page</div>
			<div id="terms">
				<iframe class="full-width" src="../terms.html"
					onLoad="calcHeight(this);"></iframe>
			</div>
			<div class="pageinfo">Request Account Page</div>
			<div id="request">
				<iframe class="full-width" src="../request.html"
					onLoad="calcHeight(this);"></iframe>
			</div>
			<div class="pageinfo">Student Help Page</div>
			<div id="studentHelp">
				<iframe class="full-width" src="../studentHelp.html"
					onLoad="calcHeight(this);"></iframe>
			</div>
			<div class="pageinfo">Instructor Help Page</div>
			<div id="instructorHelp">
				<iframe class="full-width" src="../instructorHelp.html"
					onLoad="calcHeight(this);"></iframe>
			</div>
...
<script type="text/javascript">
        $(document).ready(function(){
         ...
         // modificacion de carga de notificacion
            $('#studentNotificationPage').load("<%=Const.ActionURIs.STUDENT_COURSE_NOTIFICACION_PAGE%>?user=teammates.test&courseid=CS2104 #frameBodyWrapper",
                    function (response, status, xml) {
                        $("[data-toggle='tooltip']").tooltip({html: true}); 
                    });
            ...
            //!-- ---------------- Modificaciones--VER------------------------ -->
            $('#studentCoursesPage').load("<%=Const.ActionURIs.STUDENT_COURSES_PAGE%>?user=alice.b.tmms&courseid=CS2104 #frameBodyWrapper",
                    function (response, status, xml) {
                        $("[data-toggle='tooltip']").tooltip({html: true}); 
                    });
            //!-- ----------------FIN Modificaciones-------------------------- -->
